...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#selectcode').click(function() {
			$('#selectcode').empty();
			$.ajax({
				url : "/erp/emp/selectCode",
				type : "get",
				success : function(data) {
					$.each(data, function(index, value) {
						var objOption = document.createElement("option");
						objOption.text = value.deptname;
						objOption.value = value.deptname;
						$('#selectcode').append(objOption);
					});
		...
		<form class="form-horizontal" action="/erp/emp/insert.do"
			...
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select name="deptno" class="form-control" id="selectcode">
						</select>
					</div>
				</div>
