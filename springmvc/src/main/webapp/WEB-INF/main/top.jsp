		...
		<div class="container-fluid">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="#">Page 1-3</a></li>
					...
					<li><a href="/springmvc/emp/list.do">인사관리</a></li>
					<!-- top을 누르면 왼쪽에는 emp연결메뉴...오른쪽은 사원목록 조회결과 -->
					<li><a href="/springmvc/board_write.jsp">게시판</a></li>
					<!-- 수정필요 -->
				</ul>
				<ul class="nav navbar-nav navbar-right">
					<li><a href="/springmvc/emp/insert"><span
        ...
        <% } %> --%>
					<c:choose>
						<c:when test="${ loginUser == null}">
							<li><a href="/springmvc/view/login"><span
									class="glyphicon glyphicon-log-in"></span> Login(JSTL)</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="/springmvc/logout.do"><span
									class="glyphicon glyphicon-log-in"></span> Logout(JSTL)</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
			</div>
